...
const Blog = () => {
  ...
  return (
    <div>
      <Helmet>
        <title>Blog Rénovation Énergétique 2026 — Aides, Prix & Conseils</title>
        <meta name="description" content="Guides 2026 : MaPrimeRénov', prix pompe à chaleur, isolation, panneaux solaires. Conseils d'experts pour réduire vos factures." />
        <link rel="canonical" href="https://supremenergies.com/blog" />
        <meta property="og:title" content="Blog Rénovation Énergétique 2026 — Aides, Prix & Conseils" />
